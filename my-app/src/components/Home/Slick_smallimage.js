      ...
      return(
          <div id="Slick_smallimage_wrap">
              <div className="Slick_div">
                <Slider {...settings}>
                    <div className="par_img_div" onClick={()=>product_click("humidifier")}>
                        <img src={require("./small_img/가습기.png")}></img>
                        <span className="text">가습기</span>
                    </div>
                    <div className="par_img_div" onClick={()=>product_click("kimchi_refrigerator")}>
                        <img src={require("./small_img/김치냉장고.png")}></img>
                        <span className="text">김치냉장고</span>
                    </div>
                    <div className="par_img_div" onClick={()=>product_click("refrigerator")}>
                        <img src={require("./small_img/냉장고.png")}></img>
                        <span className="text">냉장고</span>
                    </div>
                    <div className="par_img_div" onClick={()=>product_click("Notebook")}>
                        <img src={require("./small_img/노트북.png")}></img>
                        <span className="text">노트북</span>
                    </div>
                    <div className="par_img_div" onClick={()=>product_click("Wireless_earphones")}>
                        <img src={require("./small_img/무선이어폰.png")}></img>
                        <span className="text">무선이어폰</span>
                    </div>
                    <div className="par_img_div" onClick={()=>product_click("blender")}>
                        <img src={require("./small_img/믹서기.png")}></img>
                        <span className="text">믹서기</span>
                    </div>
                    <div className="par_img_div" onClick={()=>product_click("rice_cooker")}>
                    ...
                    <div className="par_img_div" onClick={()=>product_click("fan")}>
                        <img src={require("./small_img/선풍기.png")}></img>
                        <span className="text">선풍기</span>
                    </div>

                    <div className="par_img_div" onClick={()=>product_click("washing_machine")}>
                        <img src={require("./small_img/세탁기.png")}></img>
                        <span className="text">세탁기</span>
                    </div>
                    <div className="par_img_div" onClick={()=>product_click("wireless_cleaner")}>
                        <img src={require("./small_img/식기세척기.png")}></img>
                        <span className="text">식기세척기</span>
                    </div>
                    <div className="par_img_div" onClick={()=>product_click("Air_conditioner")}>
                    ...
                    <div className="par_img_div" onClick={()=>product_click("dehumidifier")}>
                        <img src={require("./small_img/제습기.png")}></img>
                        <span className="text">제습기</span>
                    </div>
                    <div className="par_img_div" onClick={()=>product_click("tv")}>
